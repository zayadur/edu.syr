...
//get account number, what to do, and amount
    ...
    System.out.println("Deposits for account: " + Account.getNumDeposits());//Print number of deposits
    System.out.println("Withdrawals for account: " + Account.getNumWithdrawals());//Print number of withdrawals
    System.out.println("Total deposits for account: " + Account.getTotalDeposits());//Print total amount of deposits
    System.out.println("Total withdrawals for account: " + Account.getTotalWithdrawals());//Print total amount of withdrawals
  }
}
