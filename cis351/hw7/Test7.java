...
public class Test7 {
  ...
  public static void main(String... argv) {
    ...
    DLList<Character> dl2 = make("defghij");
    splitTest(dl2,2,make("de"),make("fghij"));
    splitTest(dl2,4,make("fghi"),make("j"));
    splitTest(dl2,5,make("j"),make(""));
    ...
    // ADD THREE NONTRIVIAL TESTS
    dl2 = make("ABC");
    revCopyTest(dl2,make("CBA"));
    dl2 = make("TESTING");
    revCopyTest(dl2,make("GNITSET"));
    dl2 = make("racecar");
    revCopyTest(dl2,make("racecar"));
    ...
    mergeTest(il1,il2,il3);     
    // ADD THREE NONTRIVIAL TESTS
    il1 = make(1,3,5); il2 = make(); il3 = make(1,3,5);
    mergeTest(il1,il2,il3);
    il1 = make(1,3,5); il2 = make(2,4,6); il3 = make(1,2,3,4,5,6);
    mergeTest(il1,il2,il3);
    il1 = make(5, 10, 15); il2 = make(3, 6, 9); il3 = make(3, 5, 6, 9, 10, 15);
    mergeTest(il1,il2,il3);
    ...
    mergeSortTest(il1,il2); 
    // ADD THREE NONTRIVIAL TESTS
    il1 = make(1,2,3,4,5,6,7);  il2 = make(); 
    mergeSortTest(il1,il2);  
    il1 = make(7,6,5,4,3,2,1);  il2 = make(10, 9, 8);
    mergeSortTest(il1,il2);
    il1 = make(4,1,7,6,5,3,2);  il2 = make(8, 9);
    mergeSortTest(il1,il2); 
  }
}